...
import { getCategoryBySlug, TransformedCategory } from "@/lib/data/adapter"; // Import the utility function and custom type
...
export default async function CategoryPage({ params }: CategoryPageProps) {
  ...
  const category: TransformedCategory | undefined = await getCategoryBySlug(slug as string, locale as string); // Use the utility function
