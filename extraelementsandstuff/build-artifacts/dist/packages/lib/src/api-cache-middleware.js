...
[${new Date().toISOString()}] API_CACHE_HIT: ${cacheKey}`;
                    ...
                    return new NextResponse(JSON.stringify(data.body), {
                        status: data.status,
                        headers: Object.assign(Object.assign({}, data.headers), { 'X-Cache': 'HIT', 'X-Cache-Key': cacheKey })
                    });
                }
...
[${new Date().toISOString()}] API_CACHE_SET: ${cacheKey} (TTL: ${ttl})`;
                    ...
                    return new NextResponse(responseBody, {
                        status: response.status,
                        headers: Object.assign(Object.assign({}, Object.fromEntries(response.headers.entries())), { 'X-Cache': 'MISS', 'X-Cache-Key': cacheKey })
                    });
                }
                return response;
            }
