...
const SiteHeader = () => {
    ...
    return (<header className="bg-gray-800 text-white p-4 shadow-md flex justify-between items-center">
      ...
      {status === 'authenticated' && (<button onClick={() => signOut({ callbackUrl: '/' })} // Redirect to home after logout
