    ...
    return (<div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-sm">
        <h2 className="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">
          Welcome to your Dashboard, {((_a = session.user) === null || _a === void 0 ? void 0 : _a.name) || ((_b = session.user) === null || _b === void 0 ? void 0 : _b.email)}!
        </h2>
      </div>
      <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm text-center">
        <p className="text-gray-700">You are logged in as {(_c = session.user) === null || _c === void 0 ? void 0 : _c.role}.</p>
      </div>
