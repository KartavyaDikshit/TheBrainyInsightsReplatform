        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <div>
                <button type="button" onClick={() => signIn("google", { callbackUrl: `/${locale}/` })} className="flex w-full items-center justify-center gap-3 rounded-md border border-gray-300 bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm hover:bg-gray-50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-0 focus-visible:outline-[#24292F]">
              ...
              <div>
                <button type="button" onClick={() => signIn("github", { callbackUrl: `/${locale}/` })} className="flex w-full items-center justify-center gap-3 rounded-md border border-gray-300 bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm hover:bg-gray-50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-0 focus-visible:outline-[#24292F]">
                  <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path fillRule="evenodd" d="M12 2C6.477 2 2 6.484 2 12.017 2 16.485 4.856 20.113 8.53 21.41c.5.092.646-.217.646-.483 0-.237-.007-.866-.012-1.703-2.754.598-3.333-1.259-3.333-1.259-.44-.118-.902-.371-1.098-.633-.36-.44-.027-.432.25-.421.3.042.462.145.623.283.337.52.893.46 1.113.35.035-.27.137-.46.25-.562-2.219-.259-4.554-1.133-4.554-4.931 0-1.09.39-1.98 1.029-2.681-.103-.25-.446-1.274.098-2.65 0 0 .84-.268 2.75 1.025A9.428 9.428 0 0112 6.83c.85.004 1.7.115 2.5.324 1.909-1.293 2.747-1.025 2.747-1.025.546 1.376.202 2.4-.102 2.651.64.701 1.028 1.591 1.028 2.681 0 3.79-2.339 4.666-4.566 4.92-.143.124-.27.38-.27.764 0 1.09.01 1.979.01 2.24 0 .268.153.576.655.483C19.141 20.11 22 16.485 22 12.017 22 6.484 17.522 2 12 2z" clipRule="evenodd"/>
                  </svg>
