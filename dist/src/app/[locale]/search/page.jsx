...
export default async function SearchPage({ params, searchParams }) {
    ...
    const query = (awaitedSearchParams === null || awaitedSearchParams === void 0 ? void 0 : awaitedSearchParams['q']) || '';
    const page = (awaitedSearchParams === null || awaitedSearchParams === void 0 ? void 0 : awaitedSearchParams['page']) ? parseInt(awaitedSearchParams['page']) : 1;
